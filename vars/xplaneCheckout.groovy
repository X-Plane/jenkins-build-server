    ...
    dir(checkoutDir) {
        ...
        if(fileExists('scripts/setup_submodules.sh')) {
            ...
            if(utils.shellIsSh(platform)) {
                ...
                bat "git config --file=.gitmodules \"submodule.\" ${remoteParent}cef.git"
                bat "git config --file=.gitmodules \"submodule.\" ${remoteParent}atc_res.git"
                bat "git config --file=.gitmodules \"submodule.\" ${remoteParent}default_apts.git"
                bat "git config --file=.gitmodules \"submodule.\" ${remoteParent}global_apts.git"
